...
const Prueba = () => {
  const [formValues, setFormValues] = useState({
    aulaProgAnual: "",
    cursoProgAnual: "curso-1305",
  });

  const [ibValues, setIbValues] = useState({
    periodoProgAnual: "ib",
    fchIni: "30/08/2023",
    fchFin: "17/09/2023",
    sesionProgAnual: "1",
  ...
  const [ibValuesDiaClase1, setIbValuesDiaClase1] = useState({
    diaClaseProgAnual: "1",
    horaInicioProgAnual: "09:00",
    horaFinProgAnual: "10:00",
  });

  const [ibValuesDiaClase3, setIbValuesDiaClase3] = useState({
    diaClaseProgAnual: "3",
    horaInicioProgAnual: "10:00",
    horaFinProgAnual: "11:00",
  });

  const [iibValues, setIIbValues] = useState({
    periodoProgAnual: "iib",
    fchIni: "02/10/2023",
    fchFin: "16/12/2023",
    sesionProgAnual: "3",
  });

  const [iibValuesDiaClase1, setIIbValuesDiaClase1] = useState({
    diaClaseProgAnual: "1",
    horaInicioProgAnual: "09:00",
    horaFinProgAnual: "10:00",
  });
  ...
  const onSubmit = () => {
    const formValuesData = {
      aulaProgAnual: formValues.aulaProgAnual,
      cursoProgAnual: formValues.cursoProgAnual,
      aPeriodos: [
        {
          ib: {
            periodoProgAnual: ibValues.periodoProgAnual,
            fchIni: ibValues.fchIni,
            fchFin: ibValues.fchFin,
            sesionProgAnual: ibValues.sesionProgAnual,
            aDiaClase: {
              1: [
                { diaClaseProgAnual: ibValuesDiaClase1.diaClaseProgAnual },
                { horaInicioProgAnual: ibValuesDiaClase1.horaInicioProgAnual },
                { horaFinProgAnual: ibValuesDiaClase1.horaFinProgAnual },
              ],
              3: [
                { diaClaseProgAnual: ibValuesDiaClase3.diaClaseProgAnual },
                { horaInicioProgAnual: ibValuesDiaClase3.horaInicioProgAnual },
                { horaFinProgAnual: ibValuesDiaClase3.horaFinProgAnual },
              ],
            },
          },
          iib: {
            periodoProgAnual: iibValues.periodoProgAnual,
            fchIni: iibValues.fchIni,
            fchFin: iibValues.fchFin,
            sesionProgAnual: iibValues.sesionProgAnual,
            aDiaClase: {
              1: [
                { diaClaseProgAnual: iibValuesDiaClase1.diaClaseProgAnual },
                { horaInicioProgAnual: iibValuesDiaClase1.horaInicioProgAnual },
                { horaFinProgAnual: iibValuesDiaClase1.horaFinProgAnual },
              ]
            },
          },
        },
    ...
    console.log(JSON.stringify(formValuesData));
  };
    ...
    <div>
      ...
      >
        <div className="modal-body info" data-select2-id="263">
          <div className="informacion-session-prog-anual" data-select2-id="262">
            <div className="row" data-select2-id="261">
              ...
              <div className="col-12 col-lg-3" data-select2-id="260">
                ...
                <select
                  ...
                  name="aulaProgAnual"
                  tabIndex={-1}
                  value={formValues.aulaProgAnual}
                  onChange={(e) =>
                    setFormValues((prev) => ({
                      ...prev,
                      aulaProgAnual: String(e.target.value),
                    }))
                  }
                >
              ...
              <div className="col-12 col-lg-3" data-select2-id="363">
                ...
                <select
                  value={formValues.cursoProgAnual}
                  onChange={(e) =>
                    setFormValues((prev) => ({
                      ...prev,
                      cursoProgAnual: String(e.target.value),
                    }))
                  }
                  className="form-control select2-hidden-accessible"
                  id="cursoProgAnual"
          ...
          <br />
          <div className="card mb-3 card-agregar-periodo" data-select2-id="959">
            ...
            {/* <Periodo
              ibValues={ibValues}
              setIbValues={setIIbValues}
              setIbValuesDiaClase1={setIbValuesDiaClase1}
              setIbValuesDiaClase1={setIbValuesDiaClase1}
              ibValuesDiaClase3={ibValuesDiaClase3}
              setIbValuesDiaClase3={setIbValuesDiaClase3}
            ...
            <div className="card-body" data-select2-id="958">
              <div className="tab-content" data-select2-id="957">
                ...
                >
                  ...
                  >
                    <div className="prog-anual-periodo" data-select2-id="967">
                      <div className="row" data-select2-id="966">
                        <div className="col" data-select2-id="965">
                          ...
                          <select
                            name="periodo1-periodoProgAnual"
                            className="form-control periodoProgAnual select2-hidden-accessible"
                            tabIndex={-1}
                            value={ibValues.periodoProgAnual}
                            onChange={(e) =>
                              setIbValues((prev) => ({
                                ...prev,
                                periodoProgAnual: String(e.target.value),
                              }))
                            }
                            aria-hidden="true"
                            data-select2-id="736"
                          >
                            <option value="ib" data-select2-id="742" selected>
                              1° Bimestre
                            </option>
                      ...
                      <div className="row" data-select2-id="970">
                        <div className="col-6 col-lg-4">
                          ...
                          <input
                            type="text"
                            value={ibValues.fchIni}
                            onChange={(e) =>
                              setIbValues((prev) => ({
                                ...prev,
                                fchIni: String(e.target.value),
                              }))
                            }
                            className="form-control datepicker-periodo fchIni"
                            name="periodo1-fchIni"
                        ...
                        <div className="col-6 col-lg-4">
                          ...
                          <input
                            ...
                            name="periodo1-fchFin"
                            data-toggle="datepicker"
                            placeholder="Elegir fecha"
                            value={ibValues.fchFin}
                            onChange={(e) =>
                              setIbValues((prev) => ({
                                ...prev,
                                fchIni: String(e.target.value),
                        ...
                        <div className="col-12 col-lg-4" data-select2-id="969">
                          <small className="form-text text-muted">
                            Sesión:
                          </small>
                          <select
                            name="periodo1-sesionProgAnual"
                            className="form-control sesionProgAnual select2-hidden-accessible"
                            tabIndex={-1}
                            value={ibValues.sesionProgAnual}
                            onChange={(e) =>
                              setIbValues((prev) => ({
                                ...prev,
                                sesionProgAnual: String(e.target.value),
                              }))
                            }
                            aria-hidden="true"
                            data-select2-id="756"
                          >
                            <option value="1" data-select2-id="794" selected>
                              Sesión 1
                            </option>
                      ...
                      >
                        <div className="row" data-select2-id="954">
                          ...
                          >
                            ...
                            <select
                              name="periodo1-diaClaseProgAnual-diaclase1"
                              className="form-control diaClaseProgAnual select2-hidden-accessible"
                              tabIndex={-1}
                              value={ibValuesDiaClase1.diaClaseProgAnual}
                              onChange={(e) =>
                                setIbValuesDiaClase1((prev) => ({
                                  ...prev,
                                  diaClaseProgAnual: String(e.target.value),
                                }))
                              }
                              aria-hidden="true"
                              data-select2-id="904"
                            >
                              <option value="1" data-select2-id="913" selected>
                                Lunes
                              </option>
                          ...
                          <div className="col-6 order-3 col-sm-3 order-sm-3">
                            ...
                            <input
                              type="time"
                              value={ibValuesDiaClase1.horaInicioProgAnual}
                              onChange={(e) =>
                                setIbValuesDiaClase1((prev) => ({
                                  ...prev,
                                  horaInicioProgAnual: String(e.target.value),
                                }))
                              }
                              className="form-control horaInicioProgAnual"
                              name="periodo1-horaInicioProgAnual-diaclase1"
                            />
                          </div>
                          <div className="col-6 order-4 col-sm-3 order-sm-3">
                            ...
                            <input
                              ...
                              name="periodo1-horaFinProgAnual-diaclase1"
                              value={ibValuesDiaClase1.horaFinProgAnual}
                              onChange={(e) =>
                                setIbValuesDiaClase1((prev) => ({
                                  ...prev,
                                  horaFinProgAnual: String(e.target.value),
                                }))
                              }
                            />
                          </div>
                      ...
                      >
                        ...
                        <div className="row" data-select2-id="962">
                          ...
                          >
                            ...
                            <select
                              name="periodo1-diaClaseProgAnual-diaclase2"
                              className="form-control diaClaseProgAnual select2-hidden-accessible"
                              tabIndex={-1}
                              value={ibValuesDiaClase3.diaClaseProgAnual}
                              onChange={(e) =>
                                setIbValuesDiaClase3((prev) => ({
                                  ...prev,
                                  diaClaseProgAnual: String(e.target.value),
                                }))
                              }
                            ...
                            >
                              ...
                              <option value="3" data-select2-id="931" selected>
                                Miércoles
                              </option>
                          ...
                          <div className="col-6 order-3 col-sm-3 order-sm-2">
                            ...
                            <input
                              type="time"
                              className="form-control horaInicioProgAnual"
                              name="periodo1-horaInicioProgAnual-diaclase2"
                              value={ibValuesDiaClase3.horaInicioProgAnual}
                              onChange={(e) =>
                                setIbValuesDiaClase3((prev) => ({
                                  ...prev,
                                  horaInicioProgAnual: String(e.target.value),
                          ...
                          <div className="col-6 order-4 col-sm-3">
                            ...
                            <input
                              type="time"
                              className="form-control horaFinProgAnual"
                              name="periodo1-horaFinProgAnual-diaclase2"
                              value={ibValuesDiaClase3.horaFinProgAnual}
                              onChange={(e) =>
                                setIbValuesDiaClase3((prev) => ({
                                  ...prev,
                                  horaFinProgAnual: String(e.target.value),
                ...
                >
                  ...
                  >
                    <div className="prog-anual-periodo" data-select2-id="974">
                      <div className="row" data-select2-id="973">
                        <div className="col" data-select2-id="972">
                          ...
                          <select
                            name="periodo2-periodoProgAnual"
                            className="form-control periodoProgAnual select2-hidden-accessible"
                            tabIndex={-1}
                            value={iibValues.periodoProgAnual}
                            onChange={(e) =>
                              setIIbValues((prev) => ({
                                ...prev,
                                periodoProgAnual: String(e.target.value),
                          ...
                          >
                            ...
                            <option value="iib" data-select2-id="753" selected>
                              2° Bimestre
                            </option>
                      ...
                      <div className="row" data-select2-id="977">
                        <div className="col-6 col-lg-4">
                          ...
                          <input
                            type="text"
                            className="form-control datepicker-periodo fchIni"
                            name="periodo2-fchIni"
                            data-toggle="datepicker"
                            placeholder="Elegir fecha"
                            value={iibValues.fchIni}
                            onChange={(e) =>
                              setIIbValues((prev) => ({
                                ...prev,
                                fchIni: String(e.target.value),
                        ...
                        <div className="col-6 col-lg-4">
                          ...
                          <input
                            type="text"
                            className="form-control datepicker-periodo fchFin"
                            name="periodo2-fchFin"
                            data-toggle="datepicker"
                            placeholder="Elegir fecha"
                            value={iibValues.fchFin}
                            onChange={(e) =>
                              setIIbValues((prev) => ({
                                ...prev,
                                fchFin: String(e.target.value),
                              }))
                            }
                          />
                        </div>
                        <div className="col-12 col-lg-4" data-select2-id="976">
                          <small className="form-text text-muted">
                            Sesión:
                          </small>
                          <select
                            name="periodo2-sesionProgAnual"
                            className="form-control sesionProgAnual select2-hidden-accessible"
                            tabIndex={-1}
                            value={iibValues.sesionProgAnual}
                            onChange={(e) =>
                              setIIbValues((prev) => ({
                                ...prev,
                                sesionProgAnual: String(e.target.value),
                          ...
                          >
                            ...
                            <option value="3" data-select2-id="870" selected>
                              Sesión 3
                            </option>
                      ...
                      >
                        <div className="row" data-select2-id="980">
                          ...
                          >
                            ...
                            <select
                              name="periodo2-diaClaseProgAnual-diaclase1"
                              className="form-control diaClaseProgAnual select2-hidden-accessible"
                              tabIndex={-1}
                              value={iibValuesDiaClase1.diaClaseProgAnual}
                              onChange={(e) =>
                                setIIbValuesDiaClase1((prev) => ({
                                  ...prev,
                                  diaClaseProgAnual: String(e.target.value),
                                }))
                              }
                              ...
                              data-select2-id="936"
                            >
                              <option value="1" data-select2-id="945" selected>
                                Lunes
                              </option>
                          ...
                          <div className="col-6 order-3 col-sm-3 order-sm-3">
                            ...
                            <input
                              type="time"
                              className="form-control horaInicioProgAnual"
                              name="periodo2-horaInicioProgAnual-diaclase1"
                              value={iibValuesDiaClase1.horaInicioProgAnual}
                              onChange={(e) =>
                                setIIbValuesDiaClase1((prev) => ({
                                  ...prev,
                                  horaInicioProgAnual: String(e.target.value),
                          ...
                          <div className="col-6 order-4 col-sm-3 order-sm-3">
                            ...
                            <input
                              type="time"
                              className="form-control horaFinProgAnual"
                              name="periodo2-horaFinProgAnual-diaclase1"
                              value={iibValuesDiaClase1.horaFinProgAnual}
                              onChange={(e) =>
                                setIIbValuesDiaClase1((prev) => ({
                                  ...prev,
                                  horaFinProgAnual: String(e.target.value),
